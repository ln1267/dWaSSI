...
! Grid numbers
      ...
      PARAMETER (MAX_GRIDS=6001,MAX_YEARS=100,MAX_HUCS=20)
! WUE
...
! SNOWPACK
      REAL SP,SNOWPACK
      INTEGER NSPM
      COMMON/SNOWPACK/SP(MAX_GRIDS,MAX_YEARS,12), NSPM(MAX_GRIDS,MAX_YEARS),SNOWPACK
...
! FLOW
      REAL STRFLOW,STRET,STRGEP, INSIF
      COMMON/FLOW/STRFLOW(MAX_GRIDS,MAX_YEARS,12),STRET(MAX_GRIDS,MAX_YEARS,12)&
     ,STRGEP(MAX_GRIDS,MAX_YEARS,12), INSIF(MAX_GRIDS,MAX_YEARS,12)
